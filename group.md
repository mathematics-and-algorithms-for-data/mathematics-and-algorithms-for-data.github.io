...
{% for group in grouped_people %}
	...
	{% unless skip %}
		...
		<div class="card mx-auto" style="max-width: 250px;"> <!-- align-items-center shadow-sm p-1 mb-3 bg-white rounded border border-light">-->
		  	{% if item.id > "" %}
...
{% for group in grouped_people %}
	...
	<div class="row">
	{% for item in group.items %}
	<div class="col-3 align-items-center shadow-sm p-1 mb-3 bg-white rounded border border-light">
		<div class="">
			{% if item.id > "" %}
				{% capture image_file %}{{ site.baseurl }}/assets/images/mugshots/{{ item.id }}.jpg{% endcapture %}
